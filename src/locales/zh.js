export default {
  ...
  user: {
    ...
    musicRequestConfirm: '确定向对方发送音乐请求？',
  ...
  access: {
    ...
    reject: '拒绝',
    approve: '同意',
    approveConfirm: '确定同意此授权？',
    rejectConfirm: '确定拒绝此授权？',
    revokeConfirm: '确定撤销此授权？',
    leave: '退出',
    viewer: '查看者',
    contributor: '贡献者',
    revoke: '撤销',
  ...
  setting: {
    ...
    autoPlayMusic: '自动播放随身听',
    autoPlayMusicDesc: '在登录后自动播放随身听',
    loadFailed: '加载设置失败',
    saveFailed: '保存设置失败',
    resetConfig: '重置个人设置',
  ...
  errors: {
    ...
    'No permission to transfer this repo': '无权转让此仓库',
    ...
    'Repo is restricted': '仓库受限',
    'Repo is not restricted': '仓库不是受限模式',
    'Repo is code type': '代码类型仓库不支持此操作',
    'Repo is restricted and you need viewer access first': '仓库受限，请先获得查看权限',
    'You are the owner': '你是仓库所有者',
    'You are not a contributor': '你不是该仓库的贡献者',
    'No permission to add item': '没有添加条目的权限',
    'No permission to delete item': '没有删除条目的权限',
    'No permission to swap item': '没有排序条目的权限',
    'Invalid Item Sort': '无效的条目排序',
    'Access already requested': '已请求过访问',
    'Access already approved': '访问已被批准',
    'Access already rejected': '访问已被拒绝',
    'Access already resolved': '访问已被处理',
    'Access record not found': '访问记录不存在',
    'Only repo owner can manage access': '只有仓库所有者可以管理授权',
    ...
    'Repo is no longer transferable': '仓库不可再转让'
  },
  maintenance: {
  ...
  walkman: {
    ...
    tipAutoPlayPrefix: '登录自动播放可在',
    tipAutoPlaySuffix: '中关闭。',
    tipNoMore: '不再提醒',
    play: '播放',
    pause: '暂停',
    prev: '上一首',
  ...
  notification: {
    ...
    likedRepo: '点赞了你的仓库',
    registered: '注册了新账号',
    viewerRequest: '申请查看你的仓库',
    viewerGranted: '同意了你的仓库查看授权',
    viewerRejected: '拒绝了你的仓库查看授权',
    contributorRequest: '申请加入你的仓库',
    contributorGranted: '同意了你的仓库贡献授权',
    contributorRejected: '拒绝了你的仓库贡献授权',
    system: '系统公告',
    request: '请求相关变动',
    viewRequests: '前往请求管理',
    markRead: '全部已读',
