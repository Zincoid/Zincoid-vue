...
<style scoped>
.access-page .page-header { padding-top: var(--spacing-xs); margin-bottom: var(--spacing-xl); display: flex; align-items: center; justify-content: space-between; gap: var(--spacing-lg); }
