            ...
            <div class="fields">
              ...
              <div class="field">
                <div class="cover-label-row">
                  ...
                  <button class="visibility-btn" :class="{ 'visibility-btn--active': createForm.visibility === 0 }" @click="createForm.visibility = 0" type="button">
                  ...
                  <button class="visibility-btn" :class="{ 'visibility-btn--active': createForm.visibility === 1 }" @click="createForm.visibility = 1" type="button">
